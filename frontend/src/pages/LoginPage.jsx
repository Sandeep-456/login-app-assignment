    ...
    <div className="min-h-screen bg-white flex">
        ...
        <div className="relative z-10 flex flex-col justify-between p-16 h-full w-full">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white text-xl font-bold tracking-wider">
              NEXUS<span className="font-light">CORP</span>
            </span>
          </div>
          ...
          <div className="max-w-md animate-slide-up">
            ...
            <p className="text-indigo-200 text-lg leading-relaxed mb-10">
              The all-in-one enterprise platform designed to streamline
              operations, manage resources, and scale your business
              effortlessly.
            </p>
            ...
            <div className="flex items-center gap-4">
              <div className="flex -space-x-3">
                <img
                  className="w-10 h-10 rounded-full border-2 border-indigo-900 shadow-sm"
                ...
                <img
                  ...
                  alt=""
                />
                <div className="w-10 h-10 rounded-full border-2 border-indigo-900 bg-white/10 backdrop-blur flex items-center justify-center text-xs text-white font-medium">
                  +2k
                </div>
              </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-24 bg-slate-50 relative">
        ...
        <div className="lg:hidden flex items-center justify-center gap-3 mb-10">
          ...
          <span className="text-slate-900 text-2xl font-bold tracking-wider">
            NEXUS<span className="font-light text-slate-500">CORP</span>
          </span>
        </div>
        ...
        >
            ...
            {error && (
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm-.75-4.75a.75.75 0 0 0 1.5 0V8.75a.75.75 0 0 0-1.5 0v4.5Zm.75-6a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Z"
                    clipRule="evenodd"
                  />
                </svg>
                <div>
          ...
          <div className="mt-10 relative">
            ...
            <div className="relative flex justify-center text-sm font-medium leading-6">
              <span className="bg-slate-50 px-6 text-slate-400 text-xs uppercase tracking-wider">
                Demo Credentials
              </span>
            </div>
          </div>
          <div className="mt-6 flex justify-center gap-4 text-sm text-slate-600 font-mono bg-white py-3 border border-slate-200 rounded-xl shadow-sm">
            <span>
              U: <strong className="text-indigo-600 font-bold">admin</strong>
            </span>
            <span className="text-slate-300">|</span>
            <span>
              P: <strong className="text-indigo-600 font-bold">admin</strong>
            </span>
          </div>
        </div>
      </div>
