    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col md:flex-row font-sans selection:bg-indigo-500/30">
        ...
        <div className="flex flex-col flex-grow pt-6 overflow-y-auto">
          ...
          <div className="flex items-center px-6 mb-8">
            ...
            <span className="text-white text-xl font-bold tracking-wide">
              NEXUS<span className="font-light text-slate-400">CORP</span>
            </span>
          </div>
          ...
          <div className="px-4 mb-6">
            <div className="flex items-center px-4 py-3 bg-slate-800/50 hover:bg-slate-800/80 transition-colors rounded-2xl border border-slate-700/50 cursor-pointer group">
              ...
              <div className="ml-3 flex-1 overflow-hidden">
                <p className="text-sm font-semibold text-white truncate capitalize group-hover:text-indigo-200 transition-colors">
                  {username}
                </p>
          ...
          <div className="mt-2 flex-1 flex flex-col px-3">
            ...
            <nav className="flex-1 space-y-1">
              <a
                href="#"
                className="bg-indigo-600/10 text-indigo-400 group flex items-center px-4 py-2.5 text-sm font-medium rounded-xl border border-indigo-500/20"
              >
                <svg
                  className="text-indigo-400 mr-3 flex-shrink-0 h-5 w-5"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
              ...
              <a
                href="#"
                className="text-slate-300 hover:bg-slate-800/80 hover:text-white group flex items-center px-4 py-2.5 text-sm font-medium rounded-xl transition-colors"
              >
                <svg
                  className="text-slate-400 group-hover:text-indigo-300 mr-3 flex-shrink-0 h-5 w-5 transition-colors"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <div className="md:hidden flex items-center justify-between bg-[#0F172A] px-4 py-4 shadow-md z-20">
          ...
          <button
            onClick={handleLogout}
            className="text-slate-400 hover:text-white p-2 bg-slate-800 rounded-lg border border-slate-700"
          >
            <svg
              className="h-5 w-5"
              fill="none"
          ...
          <div className="max-w-6xl mx-auto animate-slide-up">
              ...
              <div className="sm:flex sm:items-center sm:justify-between relative z-10">
                <div>
                  <h2 className="text-2xl font-extrabold text-slate-900 sm:text-3xl tracking-tight">
                    Welcome back,{" "}
                    <span className="capitalize bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">
                      {username}
                    </span>
                  </h2>
                  <p className="mt-2 text-base text-slate-500 max-w-2xl">
                    Here's what is happening with your projects today. You have{" "}
                ...
                <div className="mt-6 sm:mt-0 flex gap-3">
                  <button
                    type="button"
                    className="inline-flex items-center px-4 py-2.5 border border-slate-200 rounded-xl shadow-sm text-sm font-semibold text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all active:scale-[0.98]"
                  >
                    View Reports
                  </button>
                  <button
                    type="button"
                    className="inline-flex items-center px-4 py-2.5 border border-transparent rounded-xl shadow-[0_4px_14px_0_rgba(79,70,229,0.39)] hover:shadow-[0_6px_20px_rgba(79,70,229,0.23)] text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all active:scale-[0.98]"
                  >
                    <svg
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-10">
              ...
              <div className="bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-slate-200/60 rounded-2xl flex flex-col">
                <div className="p-6">
                  ...
                  <div className="mt-4 flex items-center text-sm">
                    <svg
                      className="h-4 w-4 text-rose-500 mr-1"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={2}
                    ...
                    <span className="text-slate-400 ml-2 border-l border-slate-300 pl-2">
                      Due today
                    </span>
                  </div>
                </div>
            ...
            <div className="bg-white shadow-sm border border-slate-200/60 rounded-2xl h-[400px] flex flex-col items-center justify-center p-8 text-center bg-gradient-to-b from-white to-slate-50/50">
              ...
              <p className="mt-2 text-sm text-slate-500 max-w-sm">
                Get started by creating a new project, running a diagnostic
                report, or inviting team members.
              </p>
              <div className="mt-8 flex gap-3">
                <button
                  type="button"
                  className="inline-flex items-center px-5 py-2.5 border border-transparent shadow-[0_4px_14px_0_rgba(79,70,229,0.39)] hover:shadow-[0_6px_20px_rgba(79,70,229,0.23)] text-sm font-semibold rounded-xl text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all active:scale-[0.98]"
                >
                  <svg
                    className="-ml-1 mr-2 h-5 w-5"
                    xmlns="http://www.w3.org/2000/svg"
